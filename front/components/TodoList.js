...
class TodoList extends HTMLElement {
    ...
    async removeTodo(dataId){
        // Como fetchAPI no me funciona bien por el CORS, no se porque, voy a hacerlo con una trampa. Voy a habilitar un GET para una url concreta para hacer los removes
        const response = await fetch(urlBackRemove + "delete/" + dataId);
        this.update();
    }
}
